...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/MC3c5RaFWj)
...
```sh
npx nx serve weather-application
```

To create a production bundle:

```sh
npx nx build weather-application
```

To see all available targets to run for a project, run:

```sh
npx nx show project weather-application
```
